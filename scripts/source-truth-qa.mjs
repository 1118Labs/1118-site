...
const out = path.resolve('../../artifacts/1118-source-truth-rebuild/qa', process.env.QA_RUN_NAME || 'development');
...
try {
  ...
  for (const [width, height] of [[1440,900],[1180,820],[768,1024],[390,844],[320,720]]) {
